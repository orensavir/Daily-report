# Re-create the triple-quote–free Streamlit bundle and provide a downloadable ZIP.
from pathlib import Path
import os, zipfile, shutil

root = Path("/mnt/data/daily_report_fix_bundle")
if root.exists():
    shutil.rmtree(root)
...
daily_report = '''
# Daily_report.py — triple-quote–free, single-file Streamlit app
    ...
    for d in depts:
        ...
        with c3:
            if st.button("מחק", key="del_" + str(d["id"])):
                ...
                st.rerun()
'''
daily_report_path = root / "Daily_report.py"
daily_report_path.write_text(daily_report, encoding="utf-8")

# requirements/runtime/theme
...
# Zip
zip_path = "/mnt/data/daily_report_fix_bundle.zip"
